...
Currently, I only plan to build debian based images for `arm64/v8` platform.
The images can be found under `subhamagr/activemq-artemis`.


## TODO

- [X] Debian based linux/arm64/v8 images
- [ ] Alpine based linux/arm64/v8 images 
- [ ] multi-arch images (amd64, linux/arm64/v7)
- [ ] Github Action CI-CD
...
|-------------------------------------------------------------------------------------------------------| -------------------------------------------------------------------------------------------------- |
| [`latest`](https://raw.githubusercontent.com/subhamagr/activemq-artemis-docker/master/src/Dockerfile) |  |  |
| [`2.20.0`](https://raw.githubusercontent.com/subhamagr/activemq-artemis-docker/master/src/Dockerfile) |  |  |
| [`2.19.0`](https://raw.githubusercontent.com/subhamagr/activemq-artemis-docker/master/src/Dockerfile) |  |  |
| [`2.18.0`](https://raw.githubusercontent.com/subhamagr/activemq-artemis-docker/master/src/Dockerfile) |  |  |
| [`2.17.0`](https://raw.githubusercontent.com/subhamagr/activemq-artemis-docker/master/src/Dockerfile) |  |  |
| [`2.16.0`](https://raw.githubusercontent.com/subhamagr/activemq-artemis-docker/master/src/Dockerfile) |  |  |
...
All versions of ActiveMQ Artemis are provided for the time being but versions previous to 2.16.0 shall be considered deprecated and could be removed at any time.
...
You can find how to run this image in the section *Running the image*. Beware that the default
...
Some configurations mentioned above are scripted automations that modify the
...
```bash
oc new-app --name=artemis subhamagr/activemq-artemis -e RESTORE_CONFIGURATION=true
```
...
If you have any problems with or questions about this image, please contact us through a [GitHub issue](https://github.com/subhamagr/activemq-artemis-docker/issues).

### 8.2 Contributing

You are invited to contribute new features, fixes, or updates, large or small; we are always thrilled to receive pull requests, and do our best to process them as fast as we can.

Before you start to code, we recommend discussing your plans through a [GitHub issue](https://github.com/subhamagr/activemq-artemis-docker/issues), especially for more ambitious contributions. This gives other contributors a chance to point you in the right direction, give you feedback on your design, and help you find out if someone else is working on the same thing.
